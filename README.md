...
# 重要公告：此版本（v3.0，2020年12月17日发布）为 SmartChordGen 的最后一次更新，「终极和弦替代器（UCS - Ultimate Chord Substitutor）」功能、完整用户手册和全新界面将在下次更新发布，届时软件名称同时变更为 ChordNova （中文名称不变）。
...
# Latest Release 最新版本：v3.0 [20201217] Downloads 下载 ↓ 
